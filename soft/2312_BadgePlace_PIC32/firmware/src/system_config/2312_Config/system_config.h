...
#define DRV_USART_PERIPHERAL_ID_IDX2                USART_ID_5
...
#define DRV_USART_BRG_CLOCK_IDX2                    80000000
#define DRV_USART_BAUD_RATE_IDX2                    9600
...
#define DRV_USART_XMIT_INT_SRC_IDX2                 INT_SOURCE_USART_5_TRANSMIT
#define DRV_USART_RCV_INT_SRC_IDX2                  INT_SOURCE_USART_5_RECEIVE
#define DRV_USART_ERR_INT_SRC_IDX2                  INT_SOURCE_USART_5_ERROR
#define DRV_USART_INT_VECTOR_IDX2                   INT_VECTOR_UART5
#define DRV_USART_INT_PRIORITY_IDX2                 INT_PRIORITY_LEVEL1
#define DRV_USART_INT_SUB_PRIORITY_IDX2             INT_SUBPRIORITY_LEVEL0
